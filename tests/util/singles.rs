...
use alchem::value::{add_native, add_std, Globals, MorphStatus, NativeInfo, CustomType, CustomValue, IsSingle, Type, Value};
...
async fn ntv_u1(vals: Vec<Val>, info: CoInfo, runner: &mut Run) -> Val {
  Val::Custom(OneVal)
}
